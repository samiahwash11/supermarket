...
<div class="jumbotron container">
    ...
    <a class="btn btn-primary btn-lg" href="{{ route('product.trash')}}" role="button">trashes  </a>
                ...
                <td>
                    ...
                    <div class="row">
                        <div class="d-flex gap-2">
                            ...
                            <a  class="btn btn-warning mx-2" href="{{ route('product.softDelete',$product->id)}}"> softDelete </a>
